...
::: warning 中文支持有限
Deepgram 主要针对英语优化，中文转录效果一般。如需中文转录，推荐 Soniox、火山引擎、硅基流动、ElevenLabs 或 Mistral AI。
:::
...
::: warning 中文支持有限
AssemblyAI 主要针对英语优化，中文转录效果一般。如需中文转录，推荐 Soniox、火山引擎、硅基流动、ElevenLabs 或 Mistral AI。
:::
