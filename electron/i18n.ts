...
const strings = {
  zh: {
    ...
    shortcutToggleRecordingPause: '暂停/恢复录制',
    shortcutToggleRecordingPauseAlt: '暂停/恢复录制(备用)',
    updateReady: '更新已就绪',
  ...
  en: {
    ...
    shortcutToggleRecordingPause: 'Pause/Resume Recording',
    shortcutToggleRecordingPauseAlt: 'Pause/Resume Recording (Alt)',
