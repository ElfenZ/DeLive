...
export function DeepgramLogo({ size = defaultSize, className, ...props }: LogoProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      width={size}
