...
import { parseSonioxConfig } from '../utils/sonioxConfig'
...
async function executeSoniox(
  ...
  try {
    ...
    const effectiveConfig = parseSonioxConfig({
      asyncModel: config.model,
    ...
    }, { meetingContext: config.meetingContext }).value
